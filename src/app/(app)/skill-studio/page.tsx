    ...
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="flex-shrink-0 border-b-2 border-[#1A202C] bg-[#EBF4F7] px-4 py-2.5 flex items-center gap-3">
        ...
        <div className="ml-auto">
          <a href="/skills" className="text-[8px] font-bold uppercase tracking-widest border border-gray-300 px-2 py-1 text-gray-500 hover:border-[#1A202C] hover:text-[#1A202C] transition-colors">
            ← Skills & Tools
          </a>
        </div>
      </div>
